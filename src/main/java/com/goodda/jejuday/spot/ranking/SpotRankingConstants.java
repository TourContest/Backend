...
public class SpotRankingConstants {
    ...
    // engagementScore(조회 제외) 기준 10 = 좋아요 3~4개 상당(또는 좋아요2+댓글4 등).
    // 승격이 너무 드물어 20에서 10으로 하향 조정 — 운영 데이터가 쌓이면 일일 승격률 기준으로 재튜닝할 것.
    public static final int POST_TO_SPOT_ENGAGEMENT_FLOOR = 10;
