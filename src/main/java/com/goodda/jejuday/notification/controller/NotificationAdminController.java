...
public class NotificationAdminController {
    ...
    public ResponseEntity<ApiResponse<List<NotificationTypeCountDto>>> getTypeStats(
        ...
        List<NotificationTypeCountDto> stats = notificationAdminService.getNotificationTypeStats(startDate, endDate);
    ...
    public ResponseEntity<ApiResponse<String>> cleanupOldNotifications(
        ...
        return ResponseEntity.ok(ApiResponse.onSuccess(String.format("%d개의 오래된 알림이 삭제되었습니다.", deletedCount)));
    }
    ...
    public ResponseEntity<ApiResponse<String>> cleanupReadNotifications() {
        ...
        return ResponseEntity.ok(ApiResponse.onSuccess(String.format("%d개의 읽은 알림이 삭제되었습니다.", deletedCount)));
    }
    ...
    public ResponseEntity<ApiResponse<String>> broadcastNotification(
        ...
        return ResponseEntity.ok(ApiResponse.onSuccess(String.format("%d명의 사용자에게 알림이 발송되었습니다.", sentCount)));
    }
